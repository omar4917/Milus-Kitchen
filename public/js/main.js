    ...
    $(".js-site-nav-toggle").on("click", function (e) {
        ...
        if ($("body").hasClass("menu-open")) {
            ...
            $(".site-menu .site-menu-inner > ul > li").each(function (i) {
                ...
                }, i * 30); // Changed from 100ms to 30ms - much faster
            ...
            }, 200); // Changed from 800ms to 200ms - much faster
            ...
            setTimeout(function () {
                $(".site-menu .site-menu-inner > ul > li").each(function (i) {
                    ...
                    }, i * 50); // Changed from 100ms to 50ms - faster appear
                });
            }, 150); // Changed from 500ms to 150ms - faster
        }
    });
